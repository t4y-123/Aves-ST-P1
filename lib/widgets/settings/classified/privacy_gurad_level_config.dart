...
class PrivacyGuardLevelPage extends StatelessWidget {
  static const routeName = '/settings/classfied/privacy_guard_level_config';

  const PrivacyGuardLevelPage({super.key});
