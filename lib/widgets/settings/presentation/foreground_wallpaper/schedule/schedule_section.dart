...
class ScheduleFiltersSetSettingTile extends SettingsTile {
  ...
  @override
  Widget build(BuildContext context) => Selector<FgwSchedule, FgwScheduleRow>(selector: (context, s) {
        final curSchedule = fgwSchedules.bridgeAll.firstWhereOrNull((e) => e.id == schedule.id);
