...
import 'package:aves/widgets/filter_grids/common/scenario/status_filter_grid_page.dart';
import 'package:aves/widgets/filter_grids/common/section_keys.dart';
import 'package:aves_model/aves_model.dart';
import 'package:flutter/material.dart';

class StatusFilterNavigationPage<T extends CollectionFilter, CSAD extends ChipSetActionDelegate<T>>
  ...
  const StatusFilterNavigationPage({
    super.key,
  ...
  @override
  State<StatusFilterNavigationPage<T, CSAD>> createState() => _StatusFilterNavigationPageState<T, CSAD>();
...
class _StatusFilterNavigationPageState<T extends CollectionFilter, CSAD extends ChipSetActionDelegate<T>>
    extends State<StatusFilterNavigationPage<T, CSAD>> {
