...
class ForegroundWallpaperDefaultSchedulesManagerPage extends StatelessWidget with FeedbackMixin {
  ...
  void _setAllScheduleDisplayType(BuildContext context, FgwDisplayedType newDisplayType) {
    final allRows = fgwSchedules.all;
    final newValues = {FgwScheduleRow.propDisplayType: newDisplayType};
    fgwSchedules.setExistRows(allRows, newValues);
    showFeedback(context, FeedbackType.info, context.l10n.applyCompletedFeedback);
  }
